...
edgelist <- read_csv("randfile.csv", col_names = c("from", "to")) # !MANUAL: To use the igraph functions and keyplayer below,this is all you need to change, as long as the file is in an edgelist format
